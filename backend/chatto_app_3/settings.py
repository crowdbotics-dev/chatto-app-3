"""
Django settings for chatto_app_3 project.
...
ROOT_URLCONF = 'chatto_app_3.urls'
...
WSGI_APPLICATION = 'chatto_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chatto_app_3 API",
    "DESCRIPTION": "API documentation for chatto_app_3 App",
    "VERSION": "v1",
}
